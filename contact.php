<?php
// Include necessary database and class files
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <h4 class="text-primary text-uppercase mb-2">Contact Us</h4>
                    <p class="mb-4">
                        <?php
                        echo $contact->content;
                        ?>
                    </p>
                    <p>Phone: <?php echo $settings->contact_phone; ?></p>
                    <p>Email: <?php echo $settings->contact_email; ?></p>
                    <p>TimeZone: <?php echo $settings->site_timezone; ?></p>
                    <p>Address: <?php echo $settings->contact_address; ?></p>
