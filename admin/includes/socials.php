  ...
  <div class="card has-table">
    <header class="card-header">
      <p class="card-header-title">
        <a class="button medium blue --jb-modal" href="index.php?page=socials_add">Add</a>
      </p>
          ...
          ?>
            <tr>
              ...
              <td style="text-align: center;">
                <a href="index.php?page=socials_edit&id=<?php echo $rows['id'] ?>" class="button small green --jb-modal" data-target="sample-modal-2" type="button">
                  <span class="icon">Edit</i></span>
                </a>
                <a href="index.php?page=socials&id=<?php echo $rows['id'] ?>" class="button small red --jb-modal" data-target="sample-modal" type="button">
