                ...
                <div class="field">
                    ...
                    <div class="field-body">
                        <div class="field" style="margin-bottom: 10px">
                            <input name="title" class="input" type="text" placeholder="" value="<?php echo $socials->title ?>">
                        </div>
                    </div>
                    <label class="label">Icon</label>
                    <div class="field-body">
                        <div class="field" style="margin-bottom: 10px">
                            <input name="icon" class="input" type="text" placeholder="" value="<?php echo htmlspecialchars($socials->icon) ?>">
                        </div>
                    </div>
                    <label class="label">URL</label>
                    <div class="field-body">
                        <div class="field" style="margin-bottom: 10px">
                            <input name="url" class="input" type="text" placeholder="" value="<?php echo $socials->url ?>">
                        </div>
                    </div>
